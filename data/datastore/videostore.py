...
class VideoStore:
    ...
    def populate_video(self):
        ...
        in cloud storage.     
        '''
        blob_client = get_blob_client(const.AZ_CLIPS_CONTAINER_NAME, self.get_video_name())
        if blob_client.exists():
            self.video_path = os.path.join(tempfile.gettempdir(), self.get_video_name())
    ...
    def write_video_to_cloud(self, fps=15):
        ...
        blob_client = get_blob_client(const.AZ_CLIPS_CONTAINER_NAME, video_name)
