...
CAP = cv2.VideoCapture('be_pose_estimation/data/videos/20241023/bicep_curls.mp4')
with open('be_pose_estimation/data/results/20241023/bicep_curls_thunder.json') as f:
    POSES = json.load(f)
