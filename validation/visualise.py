...
CAP = cv2.VideoCapture('be_pose_estimation/data/videos/20241023/dartboard.mp4')
with open('be_pose_estimation/data/results/20241023/dartboard_thunder.json') as f:
    POSES = json.load(f)
