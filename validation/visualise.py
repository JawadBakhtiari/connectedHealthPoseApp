...
CAP = cv2.VideoCapture('example_data/20241204/mobile/videos/primary/test_id/spin.mp4')
with open('example_data/20241204/mobile/poses/backend/uncalibrated/test_id/spin_thunder.json') as f:
    POSES = json.load(f)
