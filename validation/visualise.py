...
from exercises.tandem_walk import TandemWalk as Exercise
...
CAP = cv2.VideoCapture('be_pose_estimation/data/videos/20241023/tandem_walk.mp4')
with open('be_pose_estimation/data/results/20241023/tandem_walk_thunder.json') as f:
    POSES = json.load(f)

tandem_walk_end = 1665
exercise = Exercise(tandem_walk_end)
